...
export const BottomNavigationBar = () => {
  ...
  return (<>
    ...
    <nav class="bottom-navbar">
      ...
      <NavLink className="bottom-navlink" to={sessionStorage.getItem('token') ? "/AppLoginRegisterPage/Activity" : "/AppLoginRegisterPage/login"}><EmojiEventsIcon style={{ fontSize: 41, color: "#D2A753" }} />Activity</NavLink>
      <NavLink className="bottom-navlink" to={sessionStorage.getItem('token') ? "/AppLoginRegisterPage/Promotion" : "/AppLoginRegisterPage/login"}><DiamondIcon style={{ fontSize: 85, color: "#D2A753", clipPath: "polygon(25% 0%, 75% 0%, 100% 50%, 75% 100%, 25% 100%, 0% 50%)", padding: "0rem .5rem .4rem .5rem", marginTop: "-2rem", backgroundColor: "#333", borderRadius: "5px" }} /> Promotion</NavLink>
      <NavLink className="bottom-navlink" to={sessionStorage.getItem('token') ? "/AppLoginRegisterPage/Wallet" : "/AppLoginRegisterPage/login"}><WalletIcon style={{ fontSize: 41, color: "#D2A753" }} />Wallet</NavLink>
