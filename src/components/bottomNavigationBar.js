...
export const BottomNavigationBar = () => {
  ...
  return (<>
    ...
    <nav className="bottom-navbar">
      ...
      <NavLink className="bottom-navlink" to={localStorage.getItem('token') ? "/AppLoginRegisterPage/Account" : "/AppLoginRegisterPage/login"}><WalletIcon style={{ fontSize: 41, color: "#D2A753" }} />Wallet</NavLink>
