...
export const PaymentOptions = ({setPayment}) => {
    const [gridStyle,setGridStyle] = useState({
        grid1:{background: "linear-gradient(90deg,#C4933F -2.95%,#FAE59F 100%)"}
    })
    const handleClick=(grids,method)=>{
        setGridStyle({
    ...
    return (<>
        <div className="payment-option">
            <div style={gridStyle.grid1} onClick={()=>{handleClick("grid1",'UPI')}} className="payment-option-section">
            ...
            <div style={gridStyle.grid2} onClick={()=>{handleClick("grid2","PAYTM")}} className="payment-option-section">
            ...
            <div style={gridStyle.grid3} onClick={()=>{handleClick("grid3","UPI")}} className="payment-option-section">
            ...
            <div style={gridStyle.grid4} onClick={()=>{handleClick("grid4","PAYTM")}} className="payment-option-section">
