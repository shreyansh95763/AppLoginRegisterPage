...
export const JackpotBody=()=>{
    return(<>
        ...
        <div className="jackpot-ruls">
            ...
            <div> <img style={{width:"2.3rem",height:"2.4rem"}}alt='crown' src='https://cdn.iconscout.com/icon/premium/png-512-thumb/crown-427-964716.png?f=webp&w=256' />  Winning Star</div>
        </div>
