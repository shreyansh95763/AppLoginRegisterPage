    ...
    return(<>
        <div className='setting-pannel-container'>
            <div className='setting-pannel-div' onClick={()=>{Navigate("/AppLoginRegisterPage/Account/Notification")}} >
                ...
                <hr></hr>
                <div className='right-setting-pannel'>
                <div></div>
                    <ArrowForwardIosIcon style={{color:"#8c8a8a", fontSize:17}}/>
                </div>
            </div>
            <hr></hr>
            ...
            <div className='setting-pannel-div'>
                <div className='left-setting-pannel'>
                    <img alt="images" src="https://bdggame.in/assets/png/languageIcon-1b8f2d0a.png" />
                    <h5>Language</h5>
                </div>
                <div className='right-setting-pannel'>
                    <h5>English</h5>
