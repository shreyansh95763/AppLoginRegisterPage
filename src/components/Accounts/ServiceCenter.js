...
export const ServiceCenter = () => {
  ...
  const navToNotification=()=>{
    Navigate("/AppLoginRegisterPage/Account/Notification")
  }
    return (<>
        <div className="service-center-container">
            ...
            <div className="sevice-center-opration-container">
                ...
                <div className="service-center-divs"  onClick={()=>{Navigate("Feedback")}}>
                ...
                <div className="service-center-divs" onClick={navToNotification}>
                ...
                <div className="service-center-divs" onClick={()=>{Navigate("/AppLoginRegisterPage/CustomerService")}} >
                ...
                <div className="service-center-divs" onClick={()=>{Navigate("AboutUs")}}>
