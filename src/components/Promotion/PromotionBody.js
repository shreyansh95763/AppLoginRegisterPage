...
//   alert("Copied  ");
    ...
    return (<>
        ...
        <div className='promotion-body-container'>
            <div className='promotion-left-body'>
                <img alt="promotion-options" src="https://bdggame.in/assets/png/team_port-a127ca76.png" />
                <h5>subordinate data</h5>
            </div>
        ...
        <div className='promotion-body-container'>
            <div className='promotion-left-body'>
                <img alt="promotion-options" src="https://bdggame.in/assets/png/commission-340af997.png" />
        ...
        <div className='promotion-body-container'>
            <div className='promotion-left-body'>
                <img alt="promotion-options" src="https://bdggame.in/assets/png/invite_reg-4c4b51a1.png" />
        ...
        <div className='promotion-body-container'>
            <div className='promotion-left-body'>
                <img alt="promotion-options" src="https://bdggame.in/assets/png/server-f01e6593.png" />
                <h5>Agent line Customer Service</h5>
            </div>
            <div className='promotion-right-body'>
                <ArrowForwardIosIcon />
            </div>
