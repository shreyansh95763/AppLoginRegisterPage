...
export const DepositAmount = () => {
    ...
    return (<>
        ...
        {amount<500 || amount>50000 ?<div style={{color:"white", background: "linear-gradient(180deg, #A9AAB5 0%, #6F7381 100%)"}} className="deposite-amount-button">Deposit</div>: <div className="deposite-amount-button" >Deposit</div>}
    </>)
}